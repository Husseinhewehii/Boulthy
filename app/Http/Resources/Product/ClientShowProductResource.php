...
class ClientShowProductResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'images' => get_media_gallery_filtered_thumbnail($this, Media_Collections::PRODUCTS_GALLERY, $this->getFirstMediaUrl(Media_Collections::PRODUCTS)),
            ...
            'related_products' => ProductResource::collection($this->tag_related_products()),
        ];
    }
}
